            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-xs-9">
                        {!!Form::open(['route' => 'Admin.Salas.store','method' => 'POST','class'=>'form-vertical'])!!}
                        <div class="form-group">
                            ...
                            {!!Form::label('tipo_sala_id','Seleccione tipo de sala',['class' => 'control-label'])!!}
                            {!!Form::select('tipo_sala_id',$Tposala,'',['class' => 'form-control'])!!}

                            {!!Form::label('campus_id','Seleccione campus',['class' => 'control-label'])!!}
                    ...
                    <div class="col-md-6 col-xs-9">
                        {!!Form::open(['route' => 'files.Salas.up','method' => 'POST','enctype' =>'multipart/form-data', 'class'=>'form-vertical'])!!}
                        <div class="form-group">
