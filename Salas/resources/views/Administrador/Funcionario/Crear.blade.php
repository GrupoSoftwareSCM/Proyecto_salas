        ...
        <div class="panel-footer">
            ...
            <div class="row">
                <div class="col-md-6 col-xs-9">
                    {!!Form::open(['route' => 'Admin.Funcionario.store','method' => 'POST','class'=>'form-vertical'])!!}
                ...
                <div class="col-md-6 col-xs-9">
                    {!!Form::open(['route' => 'files.Funcionario.up','method' => 'POST','enctype' =>'multipart/form-data','class'=>'form-vertical'])!!}
                    <div class="form-group">
